...
const SideBarItem = ({ icon, title, active, setActive, link }) => {
  ...
  return (
    <li>
      <div
        className={`hover:cursor-pointer hover:scale-[102%] flex items-center p-2 text-gray-900 rounded-lg dark:text-white transition-all duration-300 ${active ? "bg-gray-300 scale-[104%]" : "hover:bg-gray-200"
          } group`}
        onClick={handleClick}
      >
        {icon}
...
const SideBarProfile = () => {
  ...
  return (
    <>
      ...
      <div className="bg-white sticky top-0 z-20 border-b-[1px] border-gray-300 mb-10">
        <button
