                            ...
                            <div className="mt-3 mx-2 sm:mx-0   sm:text-left">
                                ...
                                <div className=" space-x-2 mt-3">
                                    <div className='your-question w-full'>
                                        <textarea type="text" id="text" rows={10} className="font-inter w-full px-3 placeholder-gray-900 border rounded-lg text-sm focus:shadow-outline" placeholder="Type your question here" value={text} onChange={(e) => setText(e.target.value)} />
                                    </div>
    ...
    return (
        ...
        searchUserRedux.loading ?
            ...
            searchUserRedux.data && <>
                            ...
                            <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-50 z-40">
                                <div className="bg-white p-4 md:p-6 rounded-2xl w-10/12 md:w-1/2 lg:w-1/3 max-h-full max-w-sm space-y-2  border-2 border-y-gray-500">
                                    <div className='flex justify-center  font-inter text-base md:text-2xl space-x-3'>
                                        ...
                                        <div>
                                            <div className='font-handwritten2 text-base  ml-2'>Sending Message....</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                {openMessageModal ? <Message_Modal setOpenMessageModal={setOpenMessageModal} text={text} setText={setText} handleCreateOrder={handleCreateOrder} sendLoading={sendLoading} setSendLoading={setSendLoading} /> : null}
            </>
    )
}
