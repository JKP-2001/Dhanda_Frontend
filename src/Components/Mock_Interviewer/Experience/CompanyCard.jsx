        ...
        <>
            <div className='flex'>
                ...
                <div className="info mx-2">
                    <h1 className="font-roboto text-base font-medium mt-4">{role}</h1>
                    <h1 className="font-inter text-sm text-gray-500">{company}  {endDate?" - Full-time":""} </h1>
                    <h1 className="font-inter text-sm text-gray-500">{startYear} - {endDate?endYear:"Present"} . {currentYear-startYear} years </h1>
                </div>
