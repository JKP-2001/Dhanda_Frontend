        ...
        <div>
            {open && props.images ? (
                <div className='fixed select-none top-0 left-0 w-full h-full bg-black bg-opacity-50 flex justify-center items-center z-50'>
                    <div className='block w-[100%] lg:w-[90%] max-w-3xl pb-2 pt-0  bg-white border border-gray-200 md:rounded-lg shadow h-[100%] sm:h-[93%] relative'>
                        <div className=''>
                            <div className='flex justify-between'>
                                <h1 className='mx-4 mt-3 text-2xl font-bold font-inter text-gray-800'>Edit Post</h1>
                                <IoMdClose
                                    fontSize={25}
                        ...
                        <textarea className={`w-full ${images.length > 0 ? "h-[45%] sm:h-[55%]" : "h-[70%]"} p-2 pb-0 font-inter text-xs sm:text-sm outline-none border-0 border-b-[2px] border-gray-200 border-transparent focus:border-transparent focus:ring-0 overflow-y-auto`} placeholder='What do you want to talk about?' value={text} onChange={(e) => setText(e.target.value)}></textarea>
                        <div className='border-[1px] border-gray-200'></div>

                        <div className='absolute bottom-[3px] w-full pb-2 mr-2 z-20 bg-white'>
                            <hr className='mt-1 border-[0.1px] border-gray-200 ' />
