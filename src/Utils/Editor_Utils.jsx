...
function Placeholder() {
  return (
    <div className="pointer-events-none absolute left-2.5 top-4 inline-block select-none overflow-hidden text-base font-inter text-gray-400">
      Start a post
    </div>
  );
}
...
export {LexicalComposer, ContentEditable, RichTextPlugin, AutoFocusPlugin, LinkPlugin, ListPlugin, ToolbarPlugin, editorConfig, Placeholder}
